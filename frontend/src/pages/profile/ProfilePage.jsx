...
const ProfilePage = () => {
    ...
    const user = {
        ...
        coverImg: "/cover.png",
        bio: "Lorem ipsum dolor sit amet, consectetur adispiscing elit.",
                    ...
                    <>
                        ...
                        <div className='relative '>
                            <div className='group/cover'>
                                ...
                                {isMyProfile && (
                                    <div className='absolute top-2 right-2 rounded-full p-2 bg-primary bg-opacity-75 cursor-pointer opacity-0 group-hover/cover:opacity-100 transition duration-200'
                                ...
                                {user?.link && (
                                    <div className='flex gap-1 items-center'>
                                        <>
                                            ...
                                            <a href='https://example.com' target='_blank' rel='noreferrer' className='text-sm text-blue-500 hover:underline'>
                                                example.com
                                            </a>
                                        </>
                                    </div>
